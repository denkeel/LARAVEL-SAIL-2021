  ...
  <div class="flex w-full container mx-auto justify-between items-center">
    <nav>
      ...
      <ul class="flex items-center align-center font-medium text-sm text-black uppercase no-underline">
        @auth
        <li><a class="hover:text-gray-600 px-4" href="{{ url('/admin') }}">Admin</a></li>
        @else
        <li><a class="hover:text-gray-600 px-4" href="{{ route('login') }}">Login</a></li>

        @if (Route::has('register'))
        <li><a class="hover:text-gray-600 px-4" href="{{ route('register') }}">Register</a></li>
        @endif
        @endauth
      </ul>
      @endif
