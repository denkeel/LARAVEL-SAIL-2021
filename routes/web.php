...
Route::group(['prefix' => 'admin/news', 'as' => 'admin/news/'], function () {
    ...
    Route::delete('/{article}', [Admin_NewsController::class, 'destroy'])->name('destroy');
...
Route::group(['prefix' => 'admin/categories', 'as' => 'admin/categories/'], function () {
    ...
    Route::put('/{category}', [Admin_CategoriesController::class, 'update'])->name('update');
    Route::delete('/{category}', [Admin_CategoriesController::class, 'destroy'])->name('destroy');
});
